shared_context 'shared examples' do
  let(:fullcontact_array_without_followers) do
    [{ 'type' => 'twitter',
       'typeId' => 'twitter',
       'typeName' => 'Twitter',
  ...
  let(:fullcontact_hash_without_type) do
    { 'typeId' => 'twitter',
      'typeName' => 'Twitter',
      'url' => 'https://twitter.com/zino0121',
      'username' => 'zino0121',
  ...
  let(:super_fullcontact_array) do
    [
      ...
      { 'type' => 'klout',
        ...
        'username' => 'Ericbobmyers',
        'id' => '27043' },
      { 'bio' =>        '#Vegas-Based, Diabetic (#T1D) #SEM Account Director. Huge #Analytics, #PPC and #Social geek tweeting about whatever entertains me at that moment.',
        'followers' => 1538,
        'following' => 1139,
        'type' => 'twitter',
        'typeId' => 'twitter',
  ...
  let(:fullcontact_data_array) do
    [{ 'bio' => 'Change Agent at IBM Design',
     ...
     { 'type' => 'vimeo',
       ...
       'username' => 'mkshftmag',
       'id' => '8360391' },
     { 'bio' =>        'Products with soul. Bringing design to value-based care at @ablehealth. Formerly @ibmdesign, @ibmresearch, @mkshftmag, @betterxdesign.',
       'followers' => 1770,
       'following' => 961,
       'type' => 'twitter',
       'typeId' => 'twitter',
     ...
     { 'type' => 'vimeo',
       ...
       'username' => 'mkshftmag',
       'id' => '8360391' },
     { 'bio' =>        "Products with soul. Bringing design to value-based care at @ablehealth. Formerly @ibmdesign, @i
    bmresearch, @mkshftmag, @betterxdesign.",
     ...
     { 'followers' => 290,
       ...
       'username' => 'stevezie' },
     { 'bio' =>        'I use technology to promote making and creativity around the world, especially in environments of scarcity.',
       'type' => 'aboutme',
       'typeId' => 'aboutme',
       'typeName' => 'About.me',
  ...
  let(:fullcontact_twitter_hash) do
    { 'bio' =>     'Products with soul. Bringing design to value-based care at @ablehealth. Formerly @ibmdesign, @ibmresearch, @mkshftmag, @betterxdesign.',
      'followers' => 1770,
      'following' => 961,
      'type' => 'twitter',
  ...
  let(:wikipedia_dead_celebrity_string) do
  ...
  let(:wikipedia_alive_celebrity_string) do
